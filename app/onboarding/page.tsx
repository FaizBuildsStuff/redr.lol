                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[#888]">Link your account for quicker login</p>
                      </div>
                    </div>
                    {user?.google_id ? (
                      <div className="flex h-9 items-center justify-center rounded-xl border border-emerald-500/20 bg-emerald-500/10 px-4 text-xs font-semibold text-emerald-300">Connected</div>
                    ) : (
                      <button
                        type="button"
                        onClick={(e) => {
                          ...
                          window.open("/api/auth/google/login?action=connect", "GoogleOAuth", `width=${width},height=${height},left=${left},top=${top}`);
                        ...
                        className="flex h-9 items-center justify-center rounded-xl bg-white px-4 text-xs font-semibold text-black hover:bg-gray-200"
                      >
                        Connect
                      </button>
                    )}
