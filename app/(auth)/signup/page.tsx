...
type SignupStep = "username" | "email" | "password" | "otp";
...
export default function Signup() {
              ...
              {step === "email" && (
                <motion.div key="email" initial={{ opacity: 0, x: 18 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -18 }} className="space-y-7">
                  ...
                  <button
                    ...
                    className="flex h-14 w-full items-center justify-center gap-3 rounded-2xl border border-white/10 bg-white/[0.03] text-sm font-semibold text-white transition-all hover:bg-white/[0.06]"
                  >
  ...
  />
              ...
              {step === "otp" && (
                <motion.div key="otp" initial={{ opacity: 0, x: 18 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -18 }} className="space-y-7">
                  <div>
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-red-500/20 bg-red-500/10">
                      <Check className="h-5 w-5 text-red-300" />
                    </div>
                    <h1 className="mt-6 text-3xl font-semibold tracking-[-0.04em] text-white">Check your email.</h1>
                    <p className="mt-3 text-sm leading-6 text-[#888]">We've sent a 6-digit verification code to <span className="text-white font-medium">{email}</span>.</p>
                  </div>
