  ...
  return (
    <div className="flex h-full flex-col justify-between">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        {/* Top Glow */}
        <div className="absolute left-[-20%] top-[-10%] h-[240px] w-[240px] rounded-full bg-red-500/10 blur-[90px]" />

        {/* Bottom Glow */}
        <div className="absolute bottom-[-15%] right-[-10%] h-[260px] w-[260px] rounded-full bg-red-600/10 blur-[110px]" />
        ...
        <motion.div
          ...
          className="absolute right-[-30px] top-[80px] opacity-[0.05]"
        >
          <svg
            width="180"
            height="180"
                  ...
                  {accountSublinks.map((sub) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex w-full items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-medium transition-all duration-300 ${isActive
            ...
            {navLinks.map((link) => {
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-300 ${isActive
      ...
      <div className="space-y-6 pt-6 border-t border-white/5">
        ...
        <Button
          onClick={handleShare}
          className="group relative h-12 w-full overflow-hidden rounded-2xl bg-red-600 text-xs font-bold uppercase tracking-[0.14em] text-white shadow-[0_10px_40px_rgba(239,68,68,0.25)] transition-all duration-500 hover:-translate-y-[2px] hover:bg-red-500 hover:shadow-[0_10px_60px_rgba(239,68,68,0.45)]"
        >
          {shared ? (
            <>
